...
public class AboutFrame extends JFrame {	
	 ...
	 */
	public AboutFrame(GammaBetaFrame mf) {
		...
		jLabel1.setForeground(GammaBetaFrame.foreColor);
		jLabel2.setForeground(GammaBetaFrame.foreColor);
		lbAuthor.setForeground(GammaBetaFrame.foreColor);
		lbVersion.setForeground(GammaBetaFrame.foreColor);
		jLabel7.setForeground(GammaBetaFrame.foreColor);
		textLicense.setBackground(GammaBetaFrame.textAreaBkgColor);
		textLicense.setForeground(GammaBetaFrame.textAreaForeColor);
	...
	private void createGUI() {
		...
		jPanel1.setBackground(GammaBetaFrame.bkgColor);
		...
		jPanel3.setBackground(GammaBetaFrame.bkgColor);
		...
		jPanel2.setBackground(GammaBetaFrame.bkgColor);
