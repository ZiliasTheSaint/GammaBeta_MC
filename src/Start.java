...
import danfulea.utils.SplashWindow;
...
public class Start {
	...
	private static boolean m_bSplashScreen=true;
	...
	/**
	 * Main method. <br>
	 * Calling the GammaBetaFrame GUI, the application entry point!
	 * @param args standard args
	 */
	public static void main(final String[] args) {
		if (m_bSplashScreen) {
            // Create and display a splash screen
			SplashWindow wSplash = new SplashWindow(
